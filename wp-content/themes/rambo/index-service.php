...
<a <?php if(!empty($link)){?> href="<?php echo esc_url( $link ); ?>" <?php } ?><?php if($opennewtab == 'yes'){ echo 'target="_blank"';}?>>
	...
	<div id="rambo_feature_page_widget-2" class="span3 home_service widget widget_rambo_feature_page_widget">
        <span class="fa-stack fa-4x icon_align_center">
            <a href="#" target="_blank">
                <i class="fa <?php echo $icon[$i]; ?> home_media_icon_1x fa-inverse"></i>
            </a>
        </span>
        <a href="#" target="_blank">
            <h2 class="widget-title"><?php echo $title[$i]; ?></h2></a>
        <p><?php echo 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters.'; ?></p>
        <p><strong>
                <a href="#"><?php _e('Read More','rambo'); ?></a>
            </strong>
        </p>
	</div>
<?php }
